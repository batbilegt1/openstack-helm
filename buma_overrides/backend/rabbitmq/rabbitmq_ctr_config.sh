...
kubectl label nodes ctr-w1 ctr-w2 ctr-w3 openstack-control-plane=enabled --overwrite
...
# Холболт шалгах
curl -v http://10.3.0.33:15672/
telnet 10.3.0.33 5672
